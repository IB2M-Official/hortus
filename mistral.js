...
async function fetchMistralAI(promptText) {
  ...
  const payload = {
    ...
    messages: [
      { role: "system", content: "Tu es un expert du jardinage et des potagers à petite échelle. Il faut que tu donne une liste de choses a faire des conseils, rapides, concis, de manière aéré en 15 lignes environ." },
